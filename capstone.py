...
def store_image_data(imagedata,ourvehicle,model,model2,gameDisplay,clock):
	...
	carImg=pygame.surfarray.make_surface(i4.swapaxes(0,1))
...
if __name__=="__main__":
	...
	try:
		...
		weather = carla.WeatherParameters( cloudiness=80.0, precipitation=80.0, precipitation_deposits=0.0,wind_intensity=0.0,sun_azimuth_angle=40.0, sun_altitude_angle=0.0,fog_density=0.0, fog_distance=0.0, fog_falloff=0.0, wetness=100.0)
