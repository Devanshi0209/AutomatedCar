...
def testprediction():
	...
	image2=cv2.imread('D:\WindowsNoEditor\PythonAPI\examples\dataset\out00745296.jpg')
...
def trainlenetwithmanualdata():
	...
	save_model(model,'D:\WindowsNoEditor\PythonAPI\examples\save_model-manualdata-lenet-nocrop-3output-nonbogus\saved_model')
...
def createLenet():
	...
	model.add(Conv2D(filters=6, kernel_size=(3, 3), activation='relu', input_shape=(140,170,1)))
...
def create_trafficdatav2():
	...
	#plt.show()
	Xtrain=Xtrain.reshape(759,140,170,1)
	print(Xtrain.shape)
	#print(Ytrain[100])
	#print(type(Ytrain[100]))
	print(Ytrain.shape)
	Xtest=Xtest.reshape(253,140,170,1)
	print(Xtest.shape)
...
if __name__=="__main__":
	model=tf.saved_model.load("D:/WindowsNoEditor/PythonAPI/examples/workspace/exported-models/my_model_ssd_new_new/saved_model")
	print(model.summary())
